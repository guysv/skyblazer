...
export default class extends PuzzleScene {
  ...
  constructor ()
  {
    ...
    this.addText(270, 240,
                          ...
                          "You and your friend feel as if you were transported back to your\nchildhood, reliving the fond memories of SKYBLAZER, gazing at\nthe open space with sheer awe.\n\n" +
